...
public class FileCryptoUtil {
	...
	public static File encrypt(String key, File inputFile) throws CryptoException, IOException {
		File outputFile = File.createTempFile(FileUtil.getFileBaseName(inputFile),
				FileUtil.getFileExtension(inputFile.getName()));
		doCrypto(Cipher.ENCRYPT_MODE, key, inputFile, outputFile);
		return outputFile;
	}
	...
	public static Key getPasswordBasedKey(int keySize, String password)
